...
void AMainCharacter::PauseInput()
{
  // Removing binding on movement functions
  PlayerInputComponent->RemoveActionBinding("MoveForward", IE_Pressed, this, &AMainCharacter::MoveForwardDown);
  PlayerInputComponent->RemoveActionBinding("MoveForward", IE_Released, this, &AMainCharacter::MoveForwardUp);
  PlayerInputComponent->RemoveActionBinding("MoveBackward", IE_Pressed, this, &AMainCharacter::MoveBackwardDown);
  PlayerInputComponent->RemoveActionBinding("MoveBackward", IE_Released, this, &AMainCharacter::MoveBackwardUp);
  PlayerInputComponent->RemoveActionBinding("MoveRight", IE_Pressed, this, &AMainCharacter::MoveRightDown);
  PlayerInputComponent->RemoveActionBinding("MoveRight", IE_Released, this, &AMainCharacter::MoveRightUp);
  PlayerInputComponent->RemoveActionBinding("MoveLeft", IE_Pressed, this, &AMainCharacter::MoveLeftDown);
  PlayerInputComponent->RemoveActionBinding("MoveLeft", IE_Released, this, &AMainCharacter::MoveLeftUp);
}
